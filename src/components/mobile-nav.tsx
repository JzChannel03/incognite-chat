...
export default function MobileNav() {
  return (
    <div className="flex justify-between align-middle items-center gap-1 md:hidden h-[70px] w-full fixed bottom-0 left-0 shadow-2xl bg-white py-3 px-8 rounded-t-2xl">
